(function(c,a){"function"===typeof define&&define.amd?define([],a):c.JSQL=a()})(this,function(){var c=function(a){this.tmp=this.data=a;this.query={debug:{count:a.length,operations:[]},options:{ignoreEmptyString:!1},select:[],distinct:void 0,sort:{}}};c.prototype._extend=function(a,b){var e={},d;for(d in a)a.hasOwnProperty(d)&&(e[d]=a[d]);for(d in b)b.hasOwnProperty(d)&&(e[d]=b[d]);return e};c.prototype._queryObj=function(a,b){return this._isObjectEmpty(b)?[]:this._filter(a,function(a){for(var d in b)if(b.hasOwnProperty(d)&&
a[d]!=b[d])return!1;return!0})};c.prototype._isObjectEmpty=function(a){for(var b in a)if(a.hasOwnProperty(b))return!1;return!0};c.prototype._getUnique=function(a){var b=[];return this._filter(a,function(a){if(-1!==b.indexOf(a))return!1;b.push(a);return!0})};c.prototype._filter=function(a,b){var e=[],d,c=a.length;for(d=0;d<c;d++)b(a[d])&&e.push(a[d]);return e};c.prototype._map=function(a,b){var e=[],d,c=a.length;for(d=0;d<c;d++)e.push(b(a[d]));return e};c.prototype._pluck=function(a,b){for(var e=0,
d=a.length,c=[],e=0;e<d;e++)c.push(a[e][b]);return c};c.prototype._pluckMany=function(a,b){return this._map(a,function(a){var d={},c,f=b.length;for(c=0;c<f;c++)d[b[c]]=a[b[c]];return d})};c.prototype._stripEmptyProps=function(a){var b={},e;for(e in a)!a.hasOwnProperty(e)||"string"===typeof a[e]&&""===a[e].trim()||(b[e]=a[e]);return b};c.prototype._stripEmptyPropsFromCollection=function(a){for(var b=0,e=a.length,b=0;b<e;b++)a[b]=this._stripEmptyProps(a[b]);return a};c.prototype._addOp=function(a){this.query.debug.operations.push(a)};
c.prototype.debug=function(){return this.query.debug};c.prototype.options=function(a){this.query.options=this._extend(this.query.options,a);return this};c.prototype._applyOptions=function(a){this._getOpt("ignoreEmptyString")&&(a=this._stripEmptyPropsFromCollection(a));return a};c.prototype._getOpt=function(a){return this.query.options[a]};c.prototype.select=function(){this._addOp("select");this._reset();this.query.select=arguments;return this};c.prototype.where=function(){var a=arguments;if(0===a.length||
1===a.length&&0===a[0].length)return this;2===a.length&&"string"===typeof a[0]&&(a={},a[arguments[0]]=arguments[1],a=[a]);a=this._applyOptions(a);if(1<a.length&&this._areAllObjects(a))return this.orWhere(a),this;if(Array.isArray(a[0]))return this.orWhere(a[0]),this;if(this._isObjectEmpty(a))return this;if("object"===typeof a[0])return this._addOp("where"),this.tmp=this._queryObj(this.tmp,a[0]),this;throw"Invalid arguments for where clause";};c.prototype.contains=function(a){this._addOp("contains");
this.tmp=this._filter(this.tmp,function(b){for(var e in b)if(b.hasOwnProperty(e)&&b[e]==a)return!0;return!1});return this};c.prototype._areAllObjects=function(a){var b,e=a.length;if(0===e)return!1;for(b=0;b<e;b++)if("object"!==typeof a[b]||null===a[b])return!1;return!0};c.prototype.orWhere=function(a){this._addOp("orWhere");var b=this;this.tmp=this._filter(this.tmp,function(e){var d,c=a.length;for(d=0;d<c;d++)if(b._queryObj([e],a[d]).length)return!0;return!1});return this};c.prototype.associate=function(a,
b,e,d){var c=[],f,k=this.tmp.length,h;for(f=0;f<k;f++)h=this._queryObj(b,{id:this.tmp[f][a]}),this.tmp[f][d]=1===h.length?h[0][e]:void 0,c.push(this.tmp[f]);this.tmp=c;return this};c.prototype.sortBy=function(a,b){if("object"===typeof a){for(var c in a)a.hasOwnProperty(c)&&("desc"===a[c]?this.sortDesc(c):this.sortAsc(c));return this}"desc"===b?this.sortDesc(a):this.sortAsc(a);return this};c.prototype.sortAsc=function(a){this.query.sort[a]=1;return this};c.prototype.sortDesc=function(a){this.query.sort[a]=
-1;return this};c.prototype._getSorted=function(a,b){var c=Object.keys(b),d=this._sortFirstBy(c[0],b[c[0]]);if(1===c.length)return a.sort(d);delete b[c[0]];for(var g in b)b.hasOwnProperty(g)&&(this._addOp("sort"),d=d.thenBy(g,b[g]));return a.sort(d)};c.prototype._sortFirstBy=function(){function a(a,b){if("function"!==typeof a){var c=a;a=function(a,b){return a[c]<b[c]?-1:a[c]>b[c]?1:0}}if(1===a.length){var e=a;a=function(a,b){return e(a)<e(b)?-1:e(a)>e(b)?1:0}}return-1===b?function(b,c){return-a(b,
c)}:a}function b(b,g){b=a(b,g);b.thenBy=c;return b}function c(e,g){var f=this;e=a(e,g);return b(function(a,b){return f(a,b)||e(a,b)})}return b}();c.prototype.limit=function(a,b){this._addOp("limit");b=b||0;this.tmp=this.tmp.slice(0+b,a+b);return this};c.prototype["in"]=function(a,b){this._addOp("in");this.tmp=this._filter(this.tmp,function(c){return-1!==b.indexOf(c[a])});return this};c.prototype.notIn=function(a,b){this._addOp("notIn");this.tmp=this._filter(this.tmp,function(c){return-1===b.indexOf(c[a])});
