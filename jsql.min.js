...
e=d.length;return function(c){if("object"!==typeof c&&("function"!==typeof c||null===c))throw new TypeError("Object.keys called on non-object");var g=[],f;for(f in c)a.call(c,f)&&g.push(f);if(b)for(f=0;f<e;f++)a.call(c,d[f])&&g.push(d[f]);return g}}());Array.prototype.indexOf||(Array.prototype.indexOf=function(a,b){var d;if(null==this)throw new TypeError('"this" is null or not defined');var e=Object(this),c=e.length>>>0;if(0===c)return-1;d=+b||0;Infinity===Math.abs(d)&&(d=0);if(d>=c)return-1;for(d=
Math.max(0<=d?d:c-Math.abs(d),0);d<c;){if(d in e&&e[d]===a)return d;d++}return-1});var c=function(a){this.tmp=this.data=a;this.query={debug:{count:a.length,operations:[]},options:{ignoreEmptyString:!1},select:[],distinct:void 0,sort:{}}};c.prototype._extend=function(a,b){var d={},e;for(e in a)a.hasOwnProperty(e)&&(d[e]=a[e]);for(e in b)b.hasOwnProperty(e)&&(d[e]=b[e]);return d};c.prototype._queryObj=function(a,b){return this._isObjectEmpty(b)?[]:this._filter(a,function(a){for(var e in b)if(b.hasOwnProperty(e)&&
...
null===a[b])return!1;return!0};c.prototype._orWhere=function(a){this._addOp("orWhere");var b=this;this.tmp=this._filter(this.tmp,function(d){var c,h=a.length;for(c=0;c<h;c++)if(b._queryObj([d],a[c]).length)return!0;return!1})};c.prototype.sortBy=function(a,b){if("object"===typeof a){for(var d in a)a.hasOwnProperty(d)&&("desc"===a[d]?this.sortDesc(d):this.sortAsc(d));return this}"desc"===b?this.sortDesc(a):this.sortAsc(a);return this};c.prototype.sortAsc=function(a){this.query.sort[a]=1;return this};
c.prototype.sortDesc=function(a){this.query.sort[a]=-1;return this};c.prototype._getSorted=function(a,b){var d=Object.keys(b),c=this._sortFirstBy(d[0],b[d[0]]);if(1===d.length)return a.sort(c);delete b[d[0]];for(var h in b)b.hasOwnProperty(h)&&(this._addOp("sort"),c=c.thenBy(h,b[h]));return a.sort(c)};c.prototype._sortFirstBy=function(){function a(a,b){if("function"!==typeof a){var d=a;a=function(a,b){return a[d]<b[d]?-1:a[d]>b[d]?1:0}}if(1===a.length){var c=a;a=function(a,b){return c(a)<c(b)?-1:
c(a)>c(b)?1:0}}return-1===b?function(b,d){return-a(b,d)}:a}function b(b,c){b=a(b,c);b.thenBy=d;return b}function d(d,c){var g=this;d=a(d,c);return b(function(a,b){return g(a,b)||d(a,b)})}return b}();c.prototype.limit=function(a,b){this._addOp("limit");b=b||0;this.tmp=this.tmp.slice(0+b,a+b);return this};c.prototype.isIn=function(a,b){this._addOp("in");this.tmp=this._filter(this.tmp,function(d){return-1!==b.indexOf(d[a])});return this};c.prototype.isNotIn=function(a,b){this._addOp("notIn");this.tmp=
